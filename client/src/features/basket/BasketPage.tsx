            ...
            <TableBody>
                ...
                >
                    ...
                    <TableCell align="right">
                        <LoadingButton loading={status.loading && status.name === 'remAll' + item.productId}  onClick={()=> handleRemoveItem(item.productId, item.quantity, 'remAll' + item.productId)} color="error">
                            <Delete/>
                        </LoadingButton>
                    </TableCell>
                </TableRow>
